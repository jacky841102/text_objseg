...
pretrained_model = './exp-referit/tfmodel/deeplab101/referit_fc8_seg_lowres_lstm_iter_30000.tfmodel'
...
scores = segmodel.text_objseg_full_conv(text_seq_batch, imcrop_batch,
    num_vocab, embed_dim, lstm_dim, mlp_hidden_dims, deeplab_dropout=False,
