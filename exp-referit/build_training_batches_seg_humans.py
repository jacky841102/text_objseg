...
human_list_file = './exp-referit/data/human_list'

# Saving directory
data_folder = './exp-referit/data/train_batch_seg_human/'
...
with open(human_list_file, 'r') as f:
    human_list = pickle.load(f) 
...
for n_imcrop in range(num_imcrop):
    ...
    if imcrop_name not in human_list:
        continue
